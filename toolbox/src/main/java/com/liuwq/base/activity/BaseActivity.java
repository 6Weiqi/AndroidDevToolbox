package com.liuwq.base.activity;
...
import com.liuwq.base.model.Permission;
import com.liuwq.base.util.FragmentUtil;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void requestPermissions(
            @NonNull List<String> permissions, @NonNull final PermissionCallback callback) {
        ...
        new RxPermissions(BaseActivity.this)
                ...
                .subscribe(
                        new Consumer<com.tbruyelle.rxpermissions2.Permission>() {
                            int index = 0;
                            ...
                            public void accept(com.tbruyelle.rxpermissions2.Permission permission)
                                ...
                                if (permission.granted) {
                                    permissionsGranted.add(
                                            new Permission(permission.name, true, false));
                                } else {
                                    permissionsDenied.add(
                                            new Permission(
                                                    permission.name,
                                                    false,
                                                    permission
